...
![Introduction to classes](images/class_anatomy-2.jpg)
...
![Subclassing and inheritance](images/ode.jpg)

数据为右侧函数 *f* 、初始值 *x <sub>0</sub>* 、关注区间【 *t* <sub>0</sub> *、t* <sub>e</sub> 】。这个问题的解决是一个功能![Subclassing and inheritance](images/realvaluedfunction.jpg)。一种数值算法将该解作为离散值 *u <sub> i </sub>* 的向量 *u* 给出，近似为*x*(*t<sub>I</sub>*)。这里，![Subclassing and inheritance](images/B05511_08_02.jpg)是自变量 *t* 的离散值，在物理模型中常表示时间。

一步法通过递归步骤构造解值 *u <sub>i</sub>* :

![Subclassing and inheritance](images/onestep.jpg)

这里，φ是表征单个方法的阶跃函数(参见[【28】](16.html "Appendix . References")):

*   **显式欧拉** : ![Subclassing and inheritance](images/B05511_08_03.jpg)
*   **中点法则** : ![Subclassing and inheritance](images/B05511_08_04.jpg)
*   **龙格-库塔 4** : ![Subclassing and inheritance](images/B05511_08_05.jpg)带![Subclassing and inheritance](images/B05511_08_06.jpg)
...
![Encapsulation](images/cheby2.jpg)。
...
![Encapsulation](images/cheby1-1.jpg)
...
![Exercises](images/B05511_08_01.jpg)。
