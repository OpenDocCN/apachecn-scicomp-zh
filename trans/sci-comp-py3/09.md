...
![ Arithmetic geometric mean](images/B05511_09_01.jpg)

它具有迷人的特性:

![ Arithmetic geometric mean](images/B05511_09_03.jpg)
...
![ Arithmetic geometric mean](images/B05511_09_04.jpg)
...
![Convergence acceleration](images/B05511_09_05.jpg)

两个序列具有相同的极限，但是序列![Convergence acceleration](images/B05511_09_19.jpg)收敛得明显更快。一种可能的实现如下:
...
![Convergence acceleration](images/B05511_09_06.jpg)
...
![Convergence acceleration](images/seqacceleration-e1481709869771.jpg)
...
假设我们生成由![Storing generated values](images/B05511_09_07.jpg)递归定义的序列。如果初始数据 *u* <sub>0</sub> 大于 1，则该序列迅速发散至无穷大。让我们用一个生成器来生成它:
...
![Generator expression](images/B05511_09_08.jpg)
...
![Exercises](images/B05511_09_09.jpg)

**Ex。2** →创建一个生成器，用于计算由以下关系定义的序列:

![Exercises](images/un2nm1.jpg)

**Ex。3** →生成所有偶数。

**Ex。4** →让![Exercises](images/B05511_09_10.jpg)。微积分中显示![Exercises](images/limsn.jpg)。通过实验确定最小数量 *n* ，使得![Exercises](images/tempowminus5.jpg)。为此任务使用生成器。

**Ex。5** →生成所有小于给定整数的素数。使用名为厄拉多塞筛的算法。

**Ex。6** →应用显式欧拉方法求解微分方程![Exercises](images/odesin.jpg)得到递归:

![Exercises](images/euler1.jpg)

编写一个生成器，计算给定初始值 *u* <sub>0</sub> 和给定时间步长值 *h* 的解数值 *u <sub>n</sub>* 。

**Ex。7** →使用公式计算π:

![Exercises](images/B05511_09_11.jpg)

积分可以用复合梯形法则来近似，即通过以下公式:

![Exercises](images/B05511_09_12.jpg)

其中![Exercises](images/grid_value.jpg)。
