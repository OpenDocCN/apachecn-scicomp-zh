...
![Basic plotting](images/plotting_sinexample.jpg)
...
![Basic plotting](images/plotting_polynomialfit.jpg)
...
![Basic plotting](images/plotting_scatterplot.jpg)
...
![Basic plotting](images/plotting_loglogplot.jpg)
...
![Formatting](images/table-6.1.jpg)
...
![Formatting](images/plotting_histexample.jpg)
...
![Formatting](images/plotting_sinsubplot.jpg)
...
![Meshgrid and contours](images/function_meshgrid.jpg)
...
`X`和`Y`为`(n,m)`形状的数组，使得![Meshgrid and contours](images/xijYij.jpg)包含网格点![Meshgrid and contours](images/PIJ.jpg)的坐标，如下图*(图 6.6)* :

![Meshgrid and contours](images/meshgrid.jpg)
...
![Meshgrid and contours](images/banana.jpg)
...
![Meshgrid and contours](images/rosenbrock.jpg)
...
![Meshgrid and contours](images/rosenbrock_opt.jpg)
...
![Images and contours](images/B05511_06_02.jpg)
...
![Images and contours](images/plotting_mandelbrot_gray.jpg)
...
![Images and contours](images/plotting_mandelbrot_small.jpg)
...
![Modifying line properties](images/amp_mod_sin01.jpg)
...
![Filling areas between curves](images/amp_mod_sin23.jpg)
...
![Ticks and ticklabels](images/amp_mod_sin4.jpg)
...
![Making 3D plots](images/scatter3d.jpg)
...
![Making 3D plots](images/surface_plot.jpg)
...
![Making 3D plots](images/wireframe_contours.jpg)
...
这里有一个简单的例子，用隐式表示法来演化一个圆。让圆用函数![Making movies from plots](images/2d_function-1.jpg)的零电平![Making movies from plots](images/math_circle.jpg)来表示。或者，考虑零点集合内的圆盘![Making movies from plots](images/disk_math.jpg)。如果 *f* 的值以 *v* 的速率减小，则圆将以![Making movies from plots](images/nabla_math.jpg)的速率向外移动。
...
![Making movies from plots](images/circle_evolution_0-new.jpg)
...
| ![Exercises](images/lena_cat_0.jpg) | ![Exercises](images/lena_cat_1.jpg) | … | ![Exercises](images/lena_cat_128.jpg) | … | ![Exercises](images/lena_cat_256.jpg) | … | ![Exercises](images/lena_cat_511.jpg) | ![Exercises](images/lena_cat_512.jpg) |
