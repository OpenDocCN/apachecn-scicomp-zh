...
![Optimization (scipy.optimize)](images/B02092_05_01.jpg)

现在，凸集是这样一个区域，如果我们用一条线段连接它里面的两个点，那么这条线段上的所有点也位于这个区域里面。下图描述了`convex`和非凸集:

![Optimization (scipy.optimize)](images/B02092_05_02.jpg)
...
![Multidimensional image processing (scipy.ndimage)](images/B02092_05_03.jpg)

### 聚类

聚类是将一大组对象放入多个组的过程。它使用一些参数，使得一个组(称为集群)中的对象比其他组或集群中的对象更相似。

![Clustering](images/B02092_05_04.jpg)
...
![Clustering](images/B02092_05_05.jpg)
...
![Clustering](images/B02092_05_06.jpg)
